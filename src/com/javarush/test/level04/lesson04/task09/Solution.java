...
/* Светофор
проРабота светофора для пешеходов заграммирована следующим образом: в начале каждого часа в течение трех минут горит зеленый сигнал,
...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        if ((t%5>=0) && (t%5<3))// здесь нужно добавить: "t%5==5", но, если это сделать, программа не проходит тестирование
